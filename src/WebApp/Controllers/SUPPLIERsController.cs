...
/// </summary>
	...
	public class SUPPLIERsController : Controller
	{
        ...
        [Route("Index", Name = "供应商管理 ", Order = 1)]
		public ActionResult Index() => this.View();
    [HttpGet]
    [OutputCache(Duration = 30, VaryByParam = "q")]
    public async Task<JsonResult> GetComboData(string q="",int page = 1, int rows = 10, string sort = "SUPPLIERCODE", string order = "asc") {
      try
      {
