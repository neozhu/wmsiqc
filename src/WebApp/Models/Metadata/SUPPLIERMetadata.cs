...
// <summary>Class representing a Metadata entity </summary>
    ...
    public partial class SUPPLIERMetadata
    {
        ...
        [Display(Name = "ADDRESS1",Description ="收货地址1",Prompt = "收货地址1",ResourceType = typeof(resource.SUPPLIER))]
        [MaxLength(80)]
        public string ADDRESS1 { get; set; }

        [Display(Name = "ADDRESS2",Description ="收货地址2",Prompt = "收货地址2",ResourceType = typeof(resource.SUPPLIER))]
        [MaxLength(80)]
        ...
        [Display(Name = "PHONENUMBER",Description ="联系电话",Prompt = "联系电话",ResourceType = typeof(resource.SUPPLIER))]
        [MaxLength(20)]
